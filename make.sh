...
gcc -c -iquote build src/wayland/wayland.c -o build/wayland.o
gcc -c -iquote build src/subview.c  -o build/subview.o
gcc -lcairo -lwayland-client build/subview.o build/zwlr-shell.o build/xdg-shell.o build/wayland.o -o subview
